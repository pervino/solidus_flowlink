...
module Spree
  module Flowlink
    class OrderSerializer < ActiveModel::Serializer
      ...
      has_many :line_items,  serializer: Spree::Flowlink::LineItemSerializer
      has_many :payments, serializer: Spree::Flowlink::PaymentSerializer
      has_many :promotions, serializer: Spree::Flowlink::PromotionSerializer

      has_one :shipping_address, serializer: Spree::Flowlink::AddressSerializer
      has_one :billing_address, serializer: Spree::Flowlink::AddressSerializer
