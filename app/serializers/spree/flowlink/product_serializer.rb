...
module Spree
  module Flowlink
    class ProductSerializer < ActiveModel::Serializer
      ...
      has_many :images, serializer: Spree::Flowlink::ImageSerializer
      ...
      def variants
        if object.variants.empty?
          [Spree::Flowlink::VariantSerializer.new(object.master, root:false)]
        else
          ActiveModel::ArraySerializer.new(
            object.variants,
            each_serializer: Spree::Flowlink::VariantSerializer,
            root: false
          )
        end
      end
