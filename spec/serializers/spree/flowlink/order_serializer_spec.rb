      ...
      context "format" do
        ...
        context '#channel' do
          ...
          it "sets the channel to existing value other than spree" do
            order.update_column :channel, 'flowlink'
            expect(serialized_order["channel"]).to eql "flowlink"
          end
        end
        ...
        context "promotions" do
          ...
          it "includes promotions" do
            promo_json = Spree::Flowlink::PromotionSerializer.new(promotion, root: false).as_json.stringify_keys
